...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(5), __webpack_require__(16), __webpack_require__(57).setImmediate))
...
exports.default = {
    ...
    computed: {
        ...
        filteredData: function filteredData() {
            ...
            this.searchInput = this.searchInput.toLocaleLowerCase();
            if (this.searchInput !== '') {
                return this.tableData.filter(function (item) {
                    return item.location.trim().toLocaleLowerCase().includes(_this.searchInput) || item.name.trim().toLocaleLowerCase().includes(_this.searchInput);
                });
            }

            return this.tableData;
        },
        paginatedTable: function paginatedTable() {
            var fromIndex = (this.tablePage - 1) * this.rowsPerPage;
            return this.filteredData.slice(fromIndex, fromIndex + this.rowsPerPage);
        },
        ...
        totalCurrency: function totalCurrency() {
            ...
            this.filteredData.forEach(function (item) {
                sum += Number(item.currency);
            });

            return sum;
        },
        sortClass: function sortClass() {
            return this.sortDirection === ASC ? 'sorted-desc' : 'sorted-asc';
        }
    },
    methods: {
        ...
        nextPage: function nextPage() {
            if (this.tablePage <= this.pageCount) {
                this.tablePage += 1;
            }
        },
        sortBy: function sortBy(column) {
            ...
            this.tableData.sort(function (el1, el2) {
                if (el1[_this2.sortKey] > el2[_this2.sortKey]) {
                    return _this2.sortDirection;
                }
                if (el1[_this2.sortKey] < el2[_this2.sortKey]) {
                    return -_this2.sortDirection;
                }
        ...
        openForEdit: function openForEdit(e) {
            e.target.readOnly = false;
        },
        saveCell: function () {
            var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(e, id, column) {
...
var _getters = __webpack_require__(101);
...
exports.saveItem = exports.getItemById = exports.getItems = undefined;
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.next = 2;
                        return window.axios.get('/public/data/test.json');

                    case 2:
                        items = _context.sent;

                        commit(types.ITEMS, items.data);
...
var getItemById = exports.getItemById = function getItemById(_ref3, payload) {
...
var saveItem = exports.saveItem = function () {
    var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(_ref4, payload) {
        var commit = _ref4.commit;
        return _regenerator2.default.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        commit(types.ITEM, payload);
    ...
    return function saveItem(_x2, _x3) {
...
exports.default = (_types$ITEMS$types$IT = {}, (0, _defineProperty3.default)(_types$ITEMS$types$IT, types.ITEMS, function (state, payload) {
    state.items = payload;
}), (0, _defineProperty3.default)(_types$ITEMS$types$IT, types.ITEM, function (state, payload) {
    var item = state.items.find(function (el) {
        return el.id === payload.id;
    });
    item[payload.field] = payload.value;
}), _types$ITEMS$types$IT);
...
// module
exports.push([module.i, "html {\n  font-size: 16px; }\n\n.custom-form-group {\n  margin-bottom: 1rem;\n  position: relative; }\n\n.custom-label {\n  color: #56c30f;\n  left: .5rem;\n  pointer-events: none;\n  position: absolute;\n  top: .5rem;\n  transition: .2s ease all; }\n\n.custom-input {\n  border: none;\n  border-bottom: 2px solid #56c30f;\n  outline: none;\n  padding: .5rem;\n  width: 95%; }\n  .custom-input:focus ~ .custom-label, .custom-input:valid ~ .custom-label {\n    font-size: .7rem;\n    top: -1rem; }\n\nth.active-sort {\n  background: #a2d4ad; }\n  th.active-sort::after {\n    display: inline-block;\n    font-family: 'FontAwesome';\n    position: relative; }\n\n.sorted-asc th.active-sort::after {\n  content: '\\F0DE';\n  top: .25rem; }\n\n.sorted-desc th.active-sort::after {\n  content: '\\F0DD';\n  top: -.125rem; }\n\n.question {\n  background: #0d9169;\n  border-radius: 50%;\n  color: #fff;\n  display: inline-block;\n  height: 2rem;\n  padding: .2rem;\n  position: relative;\n  text-align: center;\n  top: calc(50% - 1rem);\n  width: 2rem; }\n  .question-title {\n    background: #ddd;\n    border-radius: .4rem;\n    display: none;\n    left: 2.5rem;\n    margin-bottom: 0;\n    padding: .2rem;\n    position: absolute;\n    top: calc(50% - 1rem); }\n  .question:hover {\n    background: #0b7a58; }\n    .question:hover + .question-title {\n      display: block; }\n\n.table {\n  font-size: 1rem; }\n  .table-input {\n    border: none;\n    border-bottom: 2px solid transparent;\n    outline: none;\n    padding: .3rem; }\n    .table-input:not(:read-only):focus {\n      border-color: #b3dcbc; }\n  .table tbody td {\n    padding: .2rem; }\n    .table tbody td:first-child {\n      padding: .5rem; }\n", ""]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_vue_loader_lib_template_compiler_index_id_data_v_41ac2cb0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(45);
var disposed = false
/* script */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Table_vue__ = __webpack_require__(46);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5bd01d73_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Table_vue__ = __webpack_require__(113);
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5bd01d73_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Table_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5bd01d73_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Table_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "col-md-9 col-11 mx-auto my-4" }, [
    _c("div", { staticClass: "row no-gutters align-items-sm-center" }, [
      _c("div", { staticClass: "custom-form-group col-sm-4" }, [
        _c("input", {
          directives: [
            {
              name: "model",
      ...
      _c("div", { staticClass: "col-sm-4 text-sm-right" }, [
        _c(
          "label",
          { staticClass: "mb-sm-0", attrs: { for: "rows-per-page" } },
          [_vm._v("\n                Rows per page\n            ")]
        ),
        _vm._v(" "),
        _c(
          "select",
          {
            ...
            on: {
              change: function($event) {
                ...
                _vm.rowsPerPage = $event.target.multiple
                  ? $$selectedVal
                  : $$selectedVal[0]
              }
            }
          ...
          _vm._l(15, function(i) {
            return _c("option", { domProps: { value: i * 10 } }, [
              _vm._v(
                "\n                    " + _vm._s(i * 10) + "\n                "
              )
            ])
    ...
    _c("div", { staticClass: "table-responsive" }, [
      _c("table", { staticClass: "table" }, [
        _c("thead", [
          _c("tr", { staticClass: "table-success", class: [_vm.sortClass] }, [
            _c("th", { staticClass: "w-25" }, [_vm._v("#")]),
            _vm._v(" "),
            _c(
              "th",
              {
                staticClass: "w-25",
                class: { "active-sort": _vm.sortKey === "name" },
                on: {
            ...
            _c(
              ...
              {
                staticClass: "w-25",
                class: { "active-sort": _vm.sortKey === "location" },
                on: {
                  click: function($event) {
                    _vm.sortBy("location")
                  }
            ...
            _c(
              ...
              {
                staticClass: "w-25",
                class: { "active-sort": _vm.sortKey === "currency" },
                on: {
                  click: function($event) {
                    _vm.sortBy("currency")
                  }
        ...
        _c(
          "tbody",
          [
            _vm._l(_vm.paginatedTable, function(item, index) {
              return _c(
                "tr",
                { key: item.id },
                [
                  _c(
                    ...
                    [
                      _vm._v(
                        "\n                    " +
                          _vm._s(
                            (_vm.tablePage - 1) * _vm.rowsPerPage + index + 1
                          ) +
                          "\n                "
                      )
                    ]
                  ...
                  _vm._l(_vm.fields, function(field) {
                    return _c("td", [
                      _c("input", {
                        ...
                        on: {
                          dblclick: _vm.openForEdit,
                          blur: function($event) {
                            _vm.saveCell($event, item.id, field)
                          },
    ...
    _vm._v(" "),
    _c("div", { staticClass: "col-6 text-center mx-auto pb-3" }, [
      _c(
        "button",
        {
          staticClass: "btn btn-success",
          class: { disabled: _vm.tablePage === 1 },
          attrs: { disabled: _vm.tablePage === 1 },
      ...
      _c(
        "button",
        { staticClass: "btn btn-secondary disabled", attrs: { disabled: "" } },
        [_vm._v("\n            Page " + _vm._s(_vm.tablePage) + "\n        ")]
      ),
      _vm._v(" "),
      _c(
        "button",
        {
          staticClass: "btn btn-success",
          class: { disabled: _vm.tablePage >= _vm.pageCount },
          attrs: { disabled: _vm.tablePage >= _vm.pageCount },
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "question-wrap col-sm-4" }, [
      _c("span", { staticClass: "question" }, [_vm._v("?")]),
      _vm._v(" "),
      _c("p", { staticClass: "question-title" }, [
        _vm._v("\n                Double click a cell for edit\n            ")
      ])
    ])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5bd01d73", { render: render, staticRenderFns: staticRenderFns })
  }
}
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 4:
                            _context.next = 6;
                            return this.$store.dispatch('getItemById', {
                                id: this.id
                            });
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Item_vue__ = __webpack_require__(133);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0947649c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Item_vue__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(45);
var disposed = false
/* script */
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0947649c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Item_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0947649c_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Item_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0947649c", Component.options)
  } else {
    hotAPI.reload("data-v-0947649c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "card text-center col-6 mx-auto px-0 my-5" },
    [
      ...
      _c(
        ...
        [
          ...
          _c("p", { staticClass: "card-text" }, [
            _vm._v("\n            Id: " + _vm._s(_vm.item.id) + "\n        ")
          ]),
          _vm._v(" "),
          _c("p", { staticClass: "card-text" }, [
            _vm._v(
              "\n            Location: " +
                _vm._s(_vm.item.location) +
                "\n        "
            )
          ]),
          _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0947649c", { render: render, staticRenderFns: staticRenderFns })
  }
}
